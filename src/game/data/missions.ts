...
export const MISSIONS: MissionDef[] = [
  ...
  },
  {
    ...
    name: 'Duck Pond Days',
    emoji: '🦆',
    story: 'The duck pond is open — raise ducks and mix their special feed.',
    goals: [
      { id: 'g1', kind: 'buy_animal', target: 'duck', amount: 1, label: 'Buy 1 Duck' },
      { id: 'g2', kind: 'collect_animal', target: 'egg', amount: 4, label: 'Collect 4 Eggs' },
      { id: 'g3', kind: 'craft', target: 'duck_feed', amount: 2, label: 'Mix 2 Duck Feed' },
    ],
    rewardCoins: 175,
    rewardXp: 65,
    rewardItems: { corn: 6, tomato: 4 },
    unlocks: [],
    requires: 'm10_celebration',
  },
  {
    id: 'm12_goat_hill',
    name: 'Goat Hill',
    emoji: '🐐',
    story: 'Goats bring rich milk — keep the herd fed and the dairy busy.',
    goals: [
      { id: 'g1', kind: 'buy_animal', target: 'goat', amount: 1, label: 'Buy 1 Goat' },
      { id: 'g2', kind: 'collect_animal', target: 'goat_milk', amount: 3, label: 'Collect 3 Goat Milk' },
      { id: 'g3', kind: 'craft', target: 'goat_feed', amount: 2, label: 'Mix 2 Goat Feed' },
      { id: 'g4', kind: 'craft', target: 'butter', amount: 1, label: 'Churn 1 Butter' },
    ],
    rewardCoins: 190,
    rewardXp: 70,
    rewardItems: { oat: 6, carrot: 4 },
    unlocks: [],
    requires: 'm11_duck_pond',
  },
  {
    id: 'm13_smokehouse',
    name: 'Smokehouse',
    emoji: '🐷',
    story: 'Time for pigs — slop, bacon, and a hearty valley soup.',
    goals: [
      { id: 'g1', kind: 'buy_animal', target: 'pig', amount: 1, label: 'Buy 1 Pig' },
      { id: 'g2', kind: 'collect_animal', target: 'bacon', amount: 2, label: 'Collect 2 Bacon' },
      { id: 'g3', kind: 'craft', target: 'pig_slop', amount: 2, label: 'Cook 2 Pig Slop' },
      { id: 'g4', kind: 'craft', target: 'soup', amount: 1, label: 'Cook 1 Valley Soup' },
    ],
    rewardCoins: 210,
    rewardXp: 75,
    rewardItems: { pumpkin: 4, sunflower: 3 },
    unlocks: [],
    requires: 'm12_goat_hill',
  },
  {
    id: 'm14_master_chef',
    name: 'Master Chef',
    emoji: '👨‍🍳',
    story: 'Prove you run the whole valley — sweets, feasts, and a busy order board.',
    goals: [
      { id: 'g1', kind: 'craft', target: 'candy', amount: 2, label: 'Make 2 Candy' },
      { id: 'g2', kind: 'craft', target: 'cake', amount: 1, label: 'Bake 1 Celebration Cake' },
      { id: 'g3', kind: 'craft', target: 'pie', amount: 1, label: 'Bake 1 Harvest Pie' },
      { id: 'g4', kind: 'fulfill_order', amount: 3, label: 'Fulfill 3 Orders' },
      { id: 'g5', kind: 'own_coins', amount: 400, label: 'Hold 400 coins' },
    ],
    rewardCoins: 300,
    rewardXp: 100,
    rewardItems: { grape: 6, cotton: 4, sugar: 3 },
    unlocks: [],
    requires: 'm13_smokehouse',
  },
]
